...
import { ILGAN_SYMBOL, ILGAN_TEXT, ILJI_TEXT, SEASON, BLUNT_BY_DOMINANT, LACK_ELEM_TEXT, QUIZ_TEMPLATES } from "./content";
...
export function buildTeaser(saju) {
  ...
  return { risks: risks.slice(0, 3), opps: opps.slice(0, 3), nextDaeun };
}
