...
export const CHAPTERS = [
  { id: "ch01", no: "제1장", part: "p1", title: "나는 어떤 사람일까", widget: ["traits"] },
  { id: "ch02", no: "제2장", part: "p1", title: "나는 무엇으로 시작해 어디로 흐를까", widget: ["past"] },
  { id: "ch03", no: "제3장", part: "p1", title: "내 안의 진짜 욕구와 결핍", widget: ["needs"] },
  { id: "ch04", no: "제4장", part: "p2", title: "내 인생의 주 무기", widget: ["rarity"] },
  { id: "ch05", no: "제5장", part: "p2", title: "내 인생에서 가장 무거운 과제", widget: [] },
  { id: "ch06", no: "제6장", part: "p2", title: "앞으로 10년, 어떻게 흘러갈까", widget: ["flow"] },
  { id: "ch07", no: "제7장", part: "p3", title: "재물·직업운", widget: ["wealth", "worktype"] },
  { id: "ch08", no: "제8장", part: "p3", title: "연애·결혼운", widget: ["spouse"] },
  { id: "ch09", no: "제9장", part: "p3", title: "건강운", widget: ["health"] },
  { id: "ch10", no: "제10장", part: "p3", title: "관계운 — 귀인과 조심할 사람", widget: ["gwiin"] },
  { id: "ch11", no: "제11장", part: "p4", title: "인생이 바뀌는 전환점", widget: ["turning"] },
  { id: "ch12", no: "제12장", part: "p4", title: "반드시 조심해야 할 시기", widget: ["caution"] },
  { id: "ch13", no: "제13장", part: "p4", title: "월하노인이 알려주는 개운법", widget: ["months"] },
  { id: "letter", no: "맺음", part: "fin", title: "월하노인의 편지", widget: [] },
];
