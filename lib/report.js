...
export const CHAPTERS = [
  // v19.8: 연애·결혼운을 제3장으로 전진 — "인연 감정 서비스"라는 정체성이 초반에 드러나게
  ...
  { id: "ch08", no: "제3장", part: "p1", title: "내 인연은 언제, 어떤 모습으로 올까", widget: ["spouse"], wpos: [3] },
  { id: "ch03", no: "제4장", part: "p2", title: "내 안의 진짜 욕구와 결핍", widget: ["needs"], wpos: [1] },
  { id: "ch04", no: "제5장", part: "p2", title: "내 인생의 주 무기", widget: ["rarity"], wpos: [1] },
  { id: "ch05", no: "제6장", part: "p2", title: "내 인생에서 가장 무거운 과제", widget: [], wpos: [] },
  { id: "ch06", no: "제7장", part: "p3", title: "앞으로 10년, 어떻게 흘러갈까", widget: ["flow"], wpos: [1] },
  { id: "ch07", no: "제8장", part: "p3", title: "재물·직업운", widget: ["wealth", "worktype"], wpos: [1, 3] },
  ...
  { id: "ch13", no: "제13장", part: "p4", title: "홍서 아씨가 알려주는 개운법", widget: ["months"], wpos: [3] },
  { id: "letter", no: "맺음", part: "fin", title: "홍서 아씨의 편지", widget: [], wpos: [] },
];

// 상품 티어별 장 구성 (序 명반 해설은 전 티어 공통·무료 계산 렌더)
export const TIER_CHAPTER_IDS = {
  1: ["ch01", "ch02", "ch08", "ch06", "ch13", "letter"],
  2: ["ch01", "ch02", "ch08", "ch03", "ch04", "ch05", "ch06", "ch07", "ch09", "ch13", "letter"],
...
export function buildFacts(z, concern, loveStatus) {
  ...
  return buildFactsCore(z, concern, 전체12궁, 점수, loveStatus);
}

function buildFactsCore(z, concern, 전체12궁, 점수, loveStatus) {
  const b = z.input;
